...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //std::cout<<"light_pos: "<<light_pos.x<<endl;
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
			...
			ImGui::Text("per-pixel lighting:");
			if (ImGui::Button("Blinn-Phong")) {
				auto new_prog = Program::LoadFromFile("../resource/vs.vert", "../resource/gs.geom", "../resource/fs_blinn.frag");
			...
			if (ImGui::Button("Phong")) {
				auto new_prog = Program::LoadFromFile("../resource/vs.vert", "../resource/gs.geom", "../resource/fs.frag");
				// because we would like to switch value of prog
				// we need to release object on our own.
				prog.release();
				prog = new_prog;
			...
			ImGui::Text("per-vertex lighting:");
			if (ImGui::Button("Blinn-Phong_v")) {
				auto new_prog = Program::LoadFromFile("../resource/vs_per_vertex_blinn.vert", "../resource/gs_per_vertex.geom", "../resource/fs_per_vertex.frag");
				// because we would like to switch value of prog
				// we need to release object on our own.
				prog.release();
				prog = new_prog;
			...
			ImGui::SameLine();
			if (ImGui::Button("Phong_v")) {
				auto new_prog = Program::LoadFromFile("../resource/vs_per_vertex_phong.vert", "../resource/gs_per_vertex.geom", "../resource/fs_per_vertex.frag");
				// because we would like to switch value of prog
				// we need to release object on our own.
				prog.release();
				prog = new_prog;
			...
			ImGui::Text("per-vertex with specular light only:");
			if (ImGui::Button("Blinn-Phong_vp")) {
				auto new_prog = Program::LoadFromFile("../resource/vs_per_vertex_blinn_spec_only.vert", "../resource/gs_per_vertex.geom", "../resource/fs_per_vertex.frag");
				// because we would like to switch value of prog
				// we need to release object on our own.
				prog.release();
				prog = new_prog;
			...
			ImGui::SameLine();
			if (ImGui::Button("Phong_vp")) {
				auto new_prog = Program::LoadFromFile("../resource/vs_per_vertex_phong_spec_only.vert", "../resource/gs_per_vertex.geom", "../resource/fs_per_vertex.frag");
				// because we would like to switch value of prog
				// we need to release object on our own.
				prog.release();
				prog = new_prog;
